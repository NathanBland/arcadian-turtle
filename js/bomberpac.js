...
Bomberpac.prototype = {
  ...
  create: function () {
    ...
    this.bombs.setAll('scale.x', 0.8)
    this.bombs.setAll('scale.y', 0.8)
    ...
    this.redGhost.scale.setTo(0.8, 0.8)
    ...
    this.pinkGhost.scale.setTo(0.8, 0.8)
    ...
    this.blueGhost.scale.setTo(0.8, 0.8)
    ...
    this.yellowGhost.scale.setTo(0.8, 0.8)
